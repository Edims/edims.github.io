...
shy_base::load_sys_class('db_factory', '', 0);
class model {
	...
	final public function query($sql) {
		$sql = str_replace('shuyang_', $this->db_tablepre, $sql);
	 ...
	 * 						为字符串时[例：`name`='shuyang',`hits`=`hits`+1]。
	 *						为数组时[例: array('name'=>'shuyang','password'=>'123456')]
